...
<nav class="navbar navbar-expand-lg navbar-dark bg-danger ">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <div class="container ml-10 mr-10">
          <li class="nav-item">
            <a class="nav-link <?php echo e(($title === "BLOG") ? 'active' : ''); ?>" href="/blog">View Sales</a>
          </li>
        </div>

        <div class="container ml-10 mr-20">
    <li class="nav-item">
    <a href="<?php echo e(route('view_orders')); ?>">View Order</a>
    </li>
</div>
  ...
  <?php /**PATH C:\xampp\htdocs\first-app\my_first_app\resources\views/partials/navbar1.blade.php ENDPATH**/ ?>