            ...
            <tbody>
              <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $food): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    ...
                    <td><?php echo e($food->area->restaurant); ?></td>
                    <td>
                                            ...
                                            <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                        ...
                                                        <select name="restaurant_id" class="form-control">
                                                            <?php $__currentLoopData = $area; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subitem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($subitem->id); ?>" <?php echo e($subitem->id == $food->restaurant_id ? "selected" : ""); ?>><?php echo e($subitem->restaurant); ?></option>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <select name="restaurant_id" class="form-control">
                                    <?php $__currentLoopData = $area; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subitem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($subitem->id); ?>"><?php echo e($subitem->restaurant); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH D:\UTM\SEMESTER 5\App Development\utmarked\final\first-app\my_first_app\resources\views/menus/index.blade.php ENDPATH**/ ?>