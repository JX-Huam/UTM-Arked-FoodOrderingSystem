<nav class="navbar navbar-expand-lg navbar-dark bg-danger">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <div class="container ml-10 mr-10">
                    <li class="nav-item">
                        <button class="nav-link btn" onclick="window.location.href='/blog';">Blog</button>
                    </li>
                </div>
  ...
  <?php /**PATH C:\xampp\htdocs\first-app\my_first_app\resources\views/partials/navbar.blade.php ENDPATH**/ ?>